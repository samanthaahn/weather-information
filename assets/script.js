...
submitBtn.addEventListener("click", function () {
  fetch(
    "https://api.openweathermap.org/data/2.5/weather?q=" + input.value +"&appid=ce895f0400d0fe16be29264e2d060cb6").then(function (response) {
...
//   cardInfoCenter.innerHTML =
//     "<div class='card-center'><h5 class='card-title'>" +
//     "Date:" +
//     data.list[i].dt_txt +
//     "</h5><h6 class='card-subtitle mb-2 text-muted'>" +
//     "Temperature:" +
